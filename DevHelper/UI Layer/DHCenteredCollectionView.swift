//
//  DHCenteredCollectionView.swift
//  DevHelper
//
//  Created by Emil Karimov on 22/02/2019.
//

import UIKit

public extension UICollectionView {
    /// A convenient way to create a UICollectionView and configue it with a DHCenteredCollectionViewFlowLayout.
    ///
    /// - Parameters:
    ...
    public convenience init(frame: CGRect = .zero, centeredCollectionViewFlowLayout: DHCenteredCollectionViewFlowLayout) {
...
open class DHCenteredCollectionViewFlowLayout: UICollectionViewFlowLayout {
...
private extension DHCenteredCollectionViewFlowLayout {
